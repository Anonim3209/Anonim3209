let ws = new WebSocket("wss://script-answers.wqq.onrender.com");
let productUrl = "wss://script-answers.wqq.onrender.com";
...
ws.onclose = () => {
  setTimeout(() => {
    const newSocket = new WebSocket("wss://script-answers.wqq.onrender.com");
